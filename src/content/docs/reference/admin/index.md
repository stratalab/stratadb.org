...
| [Read IPC status](/docs/reference/admin/ipc_status) | Report this process's multi-process IPC state. |
| [Stop IPC hosting](/docs/reference/admin/ipc_stop) | Stop hosting the multi-process broker socket. |
