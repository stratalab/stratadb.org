...
```text
strata:default/default › kv put n 42
created n applied=true
strata:default/default › kv get n
42
```
...
```text
strata:default/default › json set doc '$' '{"name":"alice","age":30,"score":3.14,"active":true,"tags":["a","b"],"meta":null}'
created doc applied=true
strata:default/default › json get doc '$.age'
30
strata:default/default › json get doc '$.score'
3.14
strata:default/default › json get doc '$.active'
true
strata:default/default › json get doc '$.name'
"alice"
strata:default/default › json get doc '$.meta'
null
```
...
```text
strata:default/default › json set doc '$.age' 31
...
```text
strata:default/default › vector collection create docs 3 --metric cosine
strata:default/default › vector upsert docs a '[1,0,0]' --metadata '{"lang":"en"}'
strata:default/default › vector get docs a
{
  "data": {
...
```text
strata:default/default › event append audit '{"action":"login","user":"alice"}'
...
```text
strata:default/default › graph add-node social alice
strata:default/default › graph add-edge social alice knows bob
```
