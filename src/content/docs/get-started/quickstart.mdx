...
default  json        modified  user:ada        8
```
...
VERSION  COMMITTED_AT                    VALUE
     15  2026-09-13 06:52:24.548704 UTC  goodbye
      3  2026-09-13 06:52:16.724642 UTC  hello
```
...
```console
strata ./quickstart kv get greeting --as-of-time '2026-09-13 06:52:20Z'
```
