...
export const docsTree: TreeNode[] = [
  {
    ...
    children: [
      ...
      { label: 'Python quickstart', href: '/docs/get-started/python-quickstart' },
      { label: 'AI agent quickstart', href: '/docs/get-started/agents' },
      {
        label: 'Build an agent with rewindable state',
        href: '/docs/get-started/agent-tutorial',
      },
    ],
  },
  {
    ...
    children: [
      ...
      { label: 'Should I use Strata?', href: '/docs/learn/should-i-use-strata' },
      {
        label: 'How Strata works',
        children: [
          { label: 'Embedded databases', href: '/docs/learn/embedded-databases' },
          { label: 'Databases and storage', href: '/docs/learn/databases-and-storage' },
          ...
          { label: 'Durability', href: '/docs/learn/durability' },
        ],
      },
      {
    ...
    children: [
      {
        label: 'Python',
        children: [
          { label: 'Overview', href: '/docs/develop/python/overview' },
          { label: 'Installation', href: '/docs/develop/python/installation' },
          { label: 'Opening databases', href: '/docs/develop/python/opening-databases' },
          { label: 'Key-value' },
          { label: 'JSON' },
          { label: 'Events' },
          { label: 'Vectors' },
          { label: 'Graph' },
          { label: 'Branches', href: '/docs/develop/python/branches' },
          { label: 'Time travel', href: '/docs/develop/python/time-travel' },
          { label: 'Inference' },
          { label: 'Error handling', href: '/docs/develop/python/error-handling' },
        ],
      },
      {
        label: 'CLI',
