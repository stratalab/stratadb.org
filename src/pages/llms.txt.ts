...
## Start here
- [Quickstart for AI agents - the skill and self-describing surface](https://stratadb.org/docs/getting-started/quickstart-agents.md)
- [For AI agents - integration recipe](https://stratadb.org/docs/agents.md)
- [Python SDK](https://stratadb.org/docs/python.md)
...
- [Architecture](https://stratadb.org/architecture/index.md)
`;
