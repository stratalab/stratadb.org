/* @ts-self-types="./strata_wasm.d.ts" */
 ...
 */
export class StrataSession {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        StrataSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_stratasession_free(ptr, 0);
    }
    /**
    ...
    get branch() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.stratasession_branch(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    close() {
        const ret = wasm.stratasession_close(this.__wbg_ptr);
        if (ret[1]) {
    ...
    execute(command_json) {
        ...
        try {
            ...
            const ret = wasm.stratasession_execute(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    executeCli(line) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.stratasession_executeCli(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     */
    constructor() {
        const ret = wasm.stratasession_new();
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        StrataSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    setBranch(branch) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.stratasession_setBranch(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    setSpace(space) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.stratasession_setSpace(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    get space() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.stratasession_space(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) StrataSession.prototype[Symbol.dispose] = StrataSession.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./strata_wasm_bg.js": import0,
    };
}

const StrataSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_stratasession_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('strata_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
